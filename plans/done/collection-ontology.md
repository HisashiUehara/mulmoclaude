...
① getOntology (LLM summary)   — ✅ DONE 2026-07-15 (phase-2 graph panel shipped 2026-07-19, plans/feat-collection-ontology-graph.md)
...
**PLAN COMPLETE 2026-07-16.** ⓪ #2097/#2098 · ① #2099 · ② #2103 · ③ #2104 · ④ #2105 · ⑤ #2116 · ⑥ (this PR). Field-proven along the way: stock-quotes holders (backlinks), W杯2026 standings fully computed (rollups + derived-over-rollup, with the groupResult-enum pattern standing in for comparative row predicates). ①'s phase-2 `/collections` ontology graph panel shipped 2026-07-19 (plans/feat-collection-ontology-graph.md). Still open if demand appears: `transitions` (deferred, pull-based), promoting strict record checks to enforced once the lint runs clean.
